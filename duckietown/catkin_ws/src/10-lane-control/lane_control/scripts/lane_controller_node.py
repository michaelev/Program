...
class lane_controller(object):
	...
	#Subscription from vehicle_avoidance_control node
	self.sub_velocity = rospy.Subscriber("~velocity", Twist2DStamped, self.cbVelocity, queue_size=1)
    ...
    def cbVelocity(self, velocity):
	self.velo = velocity.v
    ...
    def cbPose(self, lane_pose_msg):
        ...
        car_control_msg.v = self.velo #*self.speed_gain #Left stick V-axis. Up is positive
